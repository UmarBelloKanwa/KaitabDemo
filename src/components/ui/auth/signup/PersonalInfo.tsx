            ...
            <Box >
                ...
                >
                    <TextField
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSetUserInfo('fullName', e.target.value)}
                    ...
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <DesktopDatePicker
                            ...
                            onChange={(value) => handleSetUserInfo('birthDate', String(value))}
                            //maxDate={new Date()}
                            slotProps={{
                                textField: {
                                    fullWidth: true,
                      ...
                      <TextField
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSetUserInfo('email', e.target.value)}
                        error={!!errors.email}
