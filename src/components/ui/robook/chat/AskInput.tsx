...
export default function AskInputBase({
  isExpanded = false,
  borderRadius = "27px",
}: {
  isExpanded?: boolean;
            ...
            <>
              {previewUrl ? (
                <img
                  src={previewUrl}
                  alt={file.name}
                  style={{ height: 75, width: 110, borderRadius: 8 }}
                />
        ...
        >
          ...
          <div style={{ display: "none" }}>
            ...
            <input
              ref={filesInputRef}
              type="file"
              accept=".pdf,.doc,.docx,.txt,.ppt,.pptx,.png,.jpg,.jpeg,.gif,.bmp,.webp"
              onChange={handleFileChanged}
            />
          </div>
