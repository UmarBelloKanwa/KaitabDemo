  ...
  return (
    ...
    >
      <EditorContext.Provider value={{ editor: previewEditor as Editor }}>
          <Box>
            <MuiTypography variant="h6" sx={{mb: 1.5, fontSize: "large"}}> {article.title} </MuiTypography>
            <MuiTypography variant="subtitle1" sx={{mb: 1}} fontWeight={500}> {article.subtitle } </MuiTypography>
            <EditorContent
